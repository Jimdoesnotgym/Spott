    ...
    private void startLocationUpdates() {
        ...
        try {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    CoordinatorLayout parent = (CoordinatorLayout)findViewById(R.id.main_parent);
                    FrameLayout frame = (FrameLayout)findViewById(R.id.frame_splash);
                ...
                .subscribe(new Observer<PlaceList>() {
                    ...
                    public void onNext(@io.reactivex.annotations.NonNull PlaceList placeList) {
                        if (placeList.results.size() == 0) {
                            ...
                            Log.d(TAG, "Jim4 " + placeList.error_message);
                        }
